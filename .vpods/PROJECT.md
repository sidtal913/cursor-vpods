...
GitHub delivery repository: https://github.com/sidtal913/cursor-vpods (branch main). Commit only this repo. A preview or Amplify URL is the host, not the repository.
What this app is: self-hosted .NET web application
